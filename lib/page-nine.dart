...
class _PageNineState extends State<PageNine> {
  ...
  Map<int, String> buttonToHint = {
    0: "Reach me through yellow slide on the top",
    1: "I am hanging on the white shirt guy",
    2: "I am on back of the brown shirt guy",
    3: "find me in water slide on left"
  };
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    if (allButtonsClicked()) {
                      speakMessage(
                          "You have found all occurrences of number 9");
                    }
          ...
          onPressed: () {
            if (!buttonClicked[index]!) {
              setState(() {
                ...
                AppScore().setStageScore(9, AppScore().getStageScore(9)! + 100);
                if (count == 4) {
                  _showStarsDialog();
                  flutterTts.speak(
