        ...
        children: [
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Image.asset(
                'assets/three.png', // Path to the image asset
          ...
          Positioned(
            top: 680, // Adjust the top position of the button
          ...
          Positioned(
            top: 810, // Adjust the top position of the button
          ...
          Positioned(
            top: 340, // Adjust the top position of the button
            right: 30, // Adjust the left position of the button
            child: Material(
              color: Colors.transparent,
              child: Ink(
                decoration: ShapeDecoration(
          ...
          Positioned(
            top: 465, // Adjust the top position of the button
            left: 330, // Adjust the left position of the button
            child: Material(
              color: Colors.transparent,
              child: Ink(
                decoration: ShapeDecoration(
