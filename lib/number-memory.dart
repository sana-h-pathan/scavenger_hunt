        ...
        builder: (context, orientation) {
          return Stack(
            children: [
              ...
              LanguageWidget(), // Add your LanguageWidget here
            ],
          );
        },
      ),
...
class _NumberMemoryGameScreenState extends State<NumberMemoryGameScreen> {
  ...
  late List<bool> showAsText; // Added this line
  ...
  void initializeGame() {
    setState(() {
      ...
      showAsText = List.generate(numbers.length, (_) => Random().nextBool()); // Initialize with random booleans
  ...
  Widget build(BuildContext context) {
    ...
    double boxWidth = (screenWidth - 50) / 4;
        ...
        Row(
          ...
          children: [
            ...
            IconButton(
              ...
              iconSize: 60,
                            onPressed: () {
                speakMessage('Match the numbers. Current Score is $score. Time left is ${_formatTime(timeLeft)}.');
              },
            ),
            IconButton(
  ...
  String _getDisplayContent(int index) {
    ...
    bool showAsTextValue = showAsText[index]; // Use the initialized list

    return cardVisible[index]
        ? (showAsTextValue ? _getSpelledNumber(number) : '$number')
        : '';
  }
  ...
  void checkMatch() {
    isProcessing = true;
      ...
      setState(() {
        ...
        if (matchCount == 6) { // Change the number of matches required to win
  ...
  void _showCongratulationDialog() {
    ...
    speakMessage('Congratulations! You matched all numbers!');
          ...
          TextButton(
            onPressed: () {
              ...
              setState(() {
                ...
                timeLeft = 90; // Reset the timer to 90 seconds
                score = 0; // Reset score
                matchCount = 0; // Reset match count
